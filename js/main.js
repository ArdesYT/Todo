...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" class="text-success" id=${index} style="padding-left: 55px;"><i class="fa fa-check-square-o"></i>Teljesítve</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><i class="fa fa-trash"></i>Törlés</button></td>
                </tr>`;
    });
